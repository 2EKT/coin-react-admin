...
function Announcements_comp() {
  ...
  const handleOpenModal = (announcement = null) => {
    ...
    setFormData(announcement ? { ...announcement } : { title: '', description: '', videoUrl: '' });
    setModal(true);
  };
                    ...
                    <CTableRow key={announcement.id}>
                      ...
                      <CTableDataCell>
                        {announcement.videoUrl ? (
                          <iframe width="200" height="100" src={announcement.videoUrl} title="Announcement Video"></iframe>
                        ) : 'No Video'}
                      </CTableDataCell>
                      <CTableDataCell>
                        <CButton 
